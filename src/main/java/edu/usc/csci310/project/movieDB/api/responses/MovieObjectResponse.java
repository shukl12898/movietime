package edu.usc.csci310.project.movieDB.api.responses;

import java.util.Date;
import java.util.List;

public class MovieObjectResponse {
    private boolean adult;
    private String backdrop_path;
    private Object belongs_to_collection; // Use Object since it can be null
    private int budget;
